...
OUTPUT_PATH = Path(
    "data/analysis/h1_hybrid_strategy_comparison.csv"
)
...
def analyze_hybrid(
    ...
    # Only highs from PREVIOUS completed
    # 1-minute bars may define the trail.
    confirmed_peak = None
    ...
    for ts, bar in bars.iterrows():
        ...
        if not active:
            ...
            if hit_trigger:
                ...
                # Do not execute the newly
                # activated trail in this bar.
                continue
        ...
        # --------------------------------
            ...
            # take or trail happened first
            # inside the same 1-minute bar.
            if hit_take and hit_trail:
                return {
                    "ExitType":
                        "SAME_BAR_TAKE_TRAIL",
                    "ReturnPct":
            ...
            # Current high becomes usable
            # only by the NEXT bar.
