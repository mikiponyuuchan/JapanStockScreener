...
def parse_pdf(path):
    ...
    # Detect EBITDA only from the table header
    # immediately before the actual results row.
    #
    # Do not classify the whole PDF as EBITDA format
    # just because the word EBITDA appears elsewhere.
    actual_index = None
    ...
    has_ebitda = (
        EBITDA in header_text
        and OPERATING in header_text
        and SALES in header_text
    )
